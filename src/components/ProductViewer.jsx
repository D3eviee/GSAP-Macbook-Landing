    ...
    return (
        <section id="product-viewer">
            ...
            <div className="controls">
                <p className="info text-center">MacbookPro | Available in 14" & 16" in Space Gray & Space Dark Colors</p>
                ...
                <div className="flex-center gap-5 mt-5">
                    ...
                    <div className="size-control">
                        ...
                        <div 
                            ...
                            className={clsx('bg-neutral-300', scale == 0.08 ? 'bg-white text-black' : 'bg-transparent text-white')}
                        >
                            <p>16"</p>
                        </div>
                    </div>
